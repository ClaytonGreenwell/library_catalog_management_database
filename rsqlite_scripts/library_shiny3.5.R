...
ui <- tagList(
  ...
  navbarPage(
    ...
    # 1. About tab: simple descriptive landing page explaining what the app contains.
    ...
    # 2. Book Checkout tab: A patron drop-down filter, a searchable book availability table, a save-to-database action button.
    ...
    tabPanel(
      ...
      # 3. Book Return tab: A patron drop-down filter, a searchable books currently check out table, a return-item action button.
      ...
      # 6. Transaction Log tab: A searchable table displaying all book checkout transactions.
